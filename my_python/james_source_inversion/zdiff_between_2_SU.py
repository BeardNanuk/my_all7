...
data1 = reader('obf/input/','Up_sp_mid_20181130_istf_350k_650k_f0500000_DT4d_8.su')
data2 = reader('obf/input/','Up_sp_mid_20181130_istf_fan7_350k_650k_f0500000_DT4d_8.su')
#output = reader('obf/output/','data_diff.su')
...
output.write('obf/output/data_diff.su',format='SU')
