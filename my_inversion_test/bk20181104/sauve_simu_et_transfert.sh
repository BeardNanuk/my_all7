...
./plot_abs_diff ./output/model_$Nit ./model_true/ vp
...
then
  ...
  ./plotvs ./model_true > /dev/null
  cp vs.png $REP/vs_modele_objectif.png
  ./plot_abs_diff ./output/model_$Nit ./model_true/ vs
...
then
  ...
  ./plotrho ./model_true > /dev/null
  cp rho.png $REP/rho_modele_objectif.png
  ./plot_abs_diff ./output/model_$Nit ./model_true/ rho
