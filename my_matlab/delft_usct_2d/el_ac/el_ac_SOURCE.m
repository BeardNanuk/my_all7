...
source_center_x = tank_half-0.00001;
...
name_of_source_file_str = sprintf('name_of_source_file          =  /scratch/gpfs/jiazeh/specfem2d/DATA/filtered_signal_no_delay \n',0);
...
fprintf(fileID,'anglesource = -90.00 \n');
