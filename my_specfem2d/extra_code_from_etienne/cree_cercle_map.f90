program cree_carte_vp 
  ...
  ! local parameters
  integer :: i,j,ispec,nspec, nombre_cercles,n, n_cercles, i_cercle,NGLL
  ...
  do i=1,n_cercles
    position_cercle(1,i)=2*ecart*longueur_cote+rand()*(longueur_cote-4*ecart*longueur_cote)
    position_cercle(2,i)=2*ecart*longueur_cote+rand()*(longueur_cote-4*ecart*longueur_cote)
